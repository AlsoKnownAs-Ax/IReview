...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      severity: 'error',
      comment: 'src/shared runs everywhere, so it imports no Node built-ins.',
    ...
    },
    {
      name: 'shared-is-platform-free',
      severity: 'error',
      comment: 'src/shared runs everywhere, so it imports neither Electron nor process-specific code.',
      from: { path: '^src/shared' },
    ...
    },
    {
      ...
      severity: 'error',
      comment: 'The sandboxed renderer imports no Node built-ins.',
    ...
    },
    {
      name: 'renderer-not-hosts-or-main',
      severity: 'error',
      comment: 'The renderer never imports Electron, main, preload or hosts.',
      from: { path: '^src/renderer' },
